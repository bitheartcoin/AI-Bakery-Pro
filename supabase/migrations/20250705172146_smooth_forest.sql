/*
  # Fix webshop orders status and VAT percentage

  1. Changes
    - Update the production_from_webshop_order function to ensure orders are properly confirmed
    - Fix the trigger to run BEFORE UPDATE to ensure status changes immediately
    - Update any existing paid orders to confirmed status
