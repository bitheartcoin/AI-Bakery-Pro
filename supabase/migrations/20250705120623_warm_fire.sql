/*
  ...
  2. Background
    - The application is using the products table for recipes, but the foreign key was incorrectly pointing to the recipes table
    - This was causing the error: "Key is not present in table recipes" when adding new production batches
*/
