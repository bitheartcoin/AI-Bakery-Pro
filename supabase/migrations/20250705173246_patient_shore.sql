/*
  # Fix VAT percentage and webshop orders

  1. Changes
     - Update default VAT percentage from 27% to 18%
     - Update existing products to use 18% VAT (in batches to avoid locks)
     - Fix webshop order processing to ensure orders are properly confirmed
     - Improve error handling in the production_from_webshop_order function
*/
