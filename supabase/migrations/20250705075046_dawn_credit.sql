/*
  # Fix authentication issues and improve session handling

  1. Security Updates
    - Fix profiles with null roles
  ...
  2. Changes
    - Update profiles table to set default role for null values
    - Update auth.users table to sync admin roles
