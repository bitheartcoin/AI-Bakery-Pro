/*
  # Hourly Wage Migration

  1. Changes
    - Renames salary column to hourly_wage in profiles and employees tables (if they exist)
    - Converts monthly salary to hourly wage (assuming 160 hours per month)
    - Creates a function to calculate total pay based on hours worked
*/
