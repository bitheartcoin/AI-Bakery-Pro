/*
  ...
  1. Purpose
     - Creates a function to clear all data from the database except admin users
     - Preserves database structure while removing all data
     - Provides a way to start fresh with a clean database

  2. Details
     - Deletes data from all application tables
     - Preserves admin user profiles
     - Includes a function to clear individual tables
