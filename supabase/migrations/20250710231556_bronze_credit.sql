/*
  # Partner User Login and Default Orders

  1. New Features
    - Create a function to create partner user accounts
    - Add default order settings
    - Add partner user login capabilities
    - Ensure partner users can access their company data
    
  2. Changes
    - Create a function to create partner user accounts
    - Add RLS policies for partner users
    - Add settings for default orders
*/
