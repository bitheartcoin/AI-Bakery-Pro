/*
  ...
  1. New Features
    - Add a function to clear the database while preserving admin users
    - Update dashboard stats function to properly track vehicles and employees
    - Add triggers on relevant tables to update stats when data changes
    
  2. Changes
    - Create clear_database() function for admin use
    - Fix dashboard stats to properly count active vehicles and employees
    - Add triggers to update stats automatically
*/
