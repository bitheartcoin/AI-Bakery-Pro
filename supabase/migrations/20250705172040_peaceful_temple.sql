/*
  # Create trigger for webshop orders

  1. New Function
    - Creates a function to automatically process webshop orders when payment status changes to 'paid'
    - Automatically changes order status to 'confirmed'
    - Creates production batches for each item in the order
    - Sends notifications to bakers
    
  2. Trigger
    - Creates a BEFORE UPDATE trigger on webshop_orders table
    - Ensures the function runs before the update is committed
*/
