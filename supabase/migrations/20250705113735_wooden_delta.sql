/*
  ...
  1. New Functions
    - `set_default_password`: Function to set default password "12345678" for new users
  
  2. Triggers
    - Add trigger to automatically set default password for new users in auth.users table
*/
