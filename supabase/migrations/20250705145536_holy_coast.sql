/*
  # Add Production Steps Table

  1. New Table
    - Create production_steps table for tracking production process steps
    - Set up proper relationships with production_batches and recipe_steps
    - Add RLS policies for security
    
  2. Schema
    - batch_id: Reference to production_batches
    - step_id: Reference to recipe_steps
    - status: Status of the step (pending, in_progress, completed, skipped)
    - start_time, end_time: When the step was started and completed
    - actual_temperature, actual_humidity: Actual environmental conditions
    - notes: Any notes about the step
*/
